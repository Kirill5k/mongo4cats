...
object FindCommand {
  final case class ShowRecord(showRecordId: Boolean)     extends FindCommand
...
object AggregateCommand {
  ...
  final case class BypassDocumentValidation(bypassDocumentValidation: Boolean) extends AggregateCommand
