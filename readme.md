...
```scala
libraryDependencies += "io.github.kirill5k" %% "mongo4cats-core" % "0.2.7"
libraryDependencies += "io.github.kirill5k" %% "mongo4cats-circe" % "0.2.7" // circe support
```
...
```scala
libraryDependencies += "io.github.kirill5k" %% "mongo4cats-circe" % "0.2.7"
```
