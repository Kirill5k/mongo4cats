...
function prepareIdxAndDocMap() {
  const docs = [  
    ...
    } ,    
    {
      "title": "mongo4cats",
      "url": "/mongo4cats/",
      "content": "mongo4cats MongoDB Java client wrapper compatible with Cats-Effect ans Fs2. Available for Scala 2.12, 2.13 and 3.0. Documentation is available in the documentation section. Dependencies Add this to your build.sbt (depends on cats-effect and FS2): libraryDependencies += \"io.github.kirill5k\" %% \"mongo4cats-core\" % \"&lt;version&gt;\" libraryDependencies += \"io.github.kirill5k\" %% \"mongo4cats-circe\" % \"&lt;version&gt;\"// circe support libraryDependencies += \"io.github.kirill5k\" %% \"mongo4cats-embedded\" % \"&lt;version&gt;\" // embedded-mongodb Quick start import cats.effect.{IO, IOApp} import mongo4cats.client.MongoClient import mongo4cats.collection.operations.Filter import mongo4cats.bson.Document object Quickstart extends IOApp.Simple { override val run: IO[Unit] = MongoClient.fromConnectionString[IO](\"mongodb://localhost:27017\").use { client =&gt; for { db &lt;- client.getDatabase(\"testdb\") coll &lt;- db.getCollection(\"docs\") _ &lt;- coll.insertMany((0 to 100).map(i =&gt; Document(\"name\" -&gt; s\"doc-$i\", \"index\" -&gt; i))) docs &lt;- coll.find .filter(Filter.gte(\"index\", 10) &amp;&amp; Filter.regex(\"name\", \"doc-[1-9]0\")) .sortByDesc(\"name\") .limit(5) .all _ &lt;- IO.println(docs) } yield () } } If you find this library useful, consider giving it a ⭐!"
    } ,    
    {
      "title": "Index",
